...
tidy_lsoa <- tidy_lsoa_data(imported_lsoa)
...
num_lso <- number_of_distinct_values(tidy_lsoa, "lsoa11_nm")
num_weeks <- number_of_distinct_values(tidy_lsoa, "week")
...
### 3.1. Removing redudant variables

### 3.2. Formatting dates to enable comparision between Headline and LSOA data

### 3.3. Setting the geographic scope

### 3.4. Calculating weekly case numbers
