...
Check the extent of population data coverage for Local Authority Districts.

```{r}
count_NA_in_df(cases_parks)


pop_figures <- cases_parks$LAD17CD %in% populations$Code
cases_parks$`LAD name`[!pop_figures]
```
...
Adjust graph for population of LAD - cases per 100,000 population

```{r}
p <- ggplot(data = subset(cases_parks_pop),
