...
total_cases_income
```
* refactoring and learning about writing functions with ggplot2 (https://fishandwhistle.net/slides/rstudioconf2020/#1) - produce plots with common features (e.g. y axis, use of facetting) but differences (e.g. x variable, colour gradient for fill)
* colour scale considerations https://stackoverflow.com/questions/58718527/setting-midpoint-for-continuous-diverging-color-scale-on-a-heatmap
* mean versus median as the appropriate measure of the average salaries within Local Authorities and across the UK as a whole
